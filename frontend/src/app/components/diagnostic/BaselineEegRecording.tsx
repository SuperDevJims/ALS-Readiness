            ...
            <div className="bg-white rounded-2xl border border-gray-100 p-5">
              ...
              <div className="flex items-center justify-center mb-4">
                <div className="relative w-28 h-16">
                  <div className="w-28 h-10 border-4 border-gray-300 rounded-full absolute top-0" />
                  <div className="w-3 h-5 bg-gray-300 rounded-sm absolute -left-1 top-4" />
                  <div className="w-3 h-5 bg-gray-300 rounded-sm absolute -right-1 top-4" />
                  <div className={`w-3 h-3 rounded-full absolute right-0 top-0 ${connected ? "bg-green-400 shadow-lg shadow-green-400/50" : "bg-gray-400"}`}
