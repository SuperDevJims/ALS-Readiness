        ...
        <div className="space-y-5">
          ...
          <section className="bg-white border border-gray-100 rounded-2xl p-6 shadow-sm">
            ...
            <div className="grid md:grid-cols-3 gap-4">
              {strands.map((test) => <StrandTestCard key={test.test_id} test={test} canAttempt={intakeComplete} disabledReason="Locked until Part I" onAttempt={() => setView({ name: "strand-attempt", test })} />)}
