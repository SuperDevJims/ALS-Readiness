...
@router.get("/learner/lri-tests", response_model=LRITestWithAttemptStatusResponse | None)
...
@router.get("/learner/lri-tests/{test_id}", response_model=LRITestWithItemsResponse | None)
async def get_lri_test_with_items(test_id: int, test_service: LRITestServiceDep):
